...
_CATNIP = Theme(name="catnip", primary="#2980b9", secondary="#1abc9c",
                accent="#27ae60", foreground="#abb2bf", background="#34495e",
                success="#27ae60", warning="#f39c12", error="#e74c3c",
                surface="#21252b", panel="#333842", dark=True, variables={
        "block-cursor-text-style": "none", "footer-key-foreground": "#2ba143",
        "input-selection-background": "#3e4451", }, )

_CATNIP_EDITOR = TextAreaTheme(name="catnip", base_style=Style(color="#abb2bf",
                                                               bgcolor="#282c34"),
                               gutter_style=Style(color="#636d83",
                                                  bgcolor="#21252b"),
                               cursor_style=Style(color="#282c34",
                                                  bgcolor="#528bff"),
                               cursor_line_style=Style(bgcolor="#2c313a"),
                               bracket_matching_style=Style(bgcolor="#3a3f4b",
                                                            bold=True),
                               cursor_line_gutter_style=Style(color="#abb2bf",
                                                              bgcolor="#2c313a"),
                               ...
                               syntax_styles={
                                   ...
                                   "yaml.field": Style(color="#61afef",
                                                       bold=True),
                                   "json.label": Style(color="#61afef",
                                                       bold=True),
                                   "toml.type": Style(color="#e5c07b"),
                                   "toml.datetime": Style(color="#c678dd",
                                                          italic=True),
                                   ...
                                   "link.uri": Style(color="#56b6c2",
                                                     underline=True),
                                   "link.label": Style(color="#c678dd"),
                                   "list.marker": Style(color="#d19a66"),
                                   "inline_code": Style(color="#d19a66"),
                                   "info_string": Style(color="#d19a66",
                                                        bold=True, italic=True),
                                   "punctuation.bracket": Style(
                                       color="#abb2bf"),
                                   "punctuation.delimiter": Style(
                                       color="#abb2bf"),
                                   "punctuation.special": Style(
                                       color="#abb2bf"),
                                   "html.end_tag_error": Style(color="#E06C75",
                                                               bold=True,
                                                               underline=True),
                                   "regex.operator": Style(color="#56B6C2",
                                                           bold=True),
                                   "regex.punctuation.bracket": Style(
                                       color="#D19A66"), }, )
